...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<div id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav"></span> ?ltere Beitr?ge', 'twentyten' ) ); ?></div>
		<div class="nav-next"><?php previous_posts_link( __( 'Neue Beitr?ge <span class="meta-nav"></span>', 'twentyten' ) ); ?></div>
	</div><!-- #nav-above -->
<?php endif; ?>
	...
	<?php else : ?>
        ...
        <div id="trenner-artikel"></div>
			...
			<div class="entry-meta">
				<?php twentyten_posted_on(); ?>
        <div id="cat-image">
          <?php the_post_thumbnail(array(700,300), array("class" => "attachment-full")) ?>
        </div>
      </div><!-- .entry-meta -->
