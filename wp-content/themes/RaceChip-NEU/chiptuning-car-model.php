...
<div class="[racechip_vchoice_class]">
  ...
  <div class="chiptuning_breadcrump">
    <a href="<?php echo get_bloginfo( 'wpurl' ); ?>/chiptuning/">Выбор автомобиля</a> &gt; <a href="<?php echo get_bloginfo( 'wpurl' ); ?>/chiptuning/<?php echo $all_data['model_brend']; ?>/"><?php echo ucwords($all_data['model_brend']); ?></a> &gt; <?php echo ucwords($wp_query->query_vars[ 'car_model' ]); ?>
  </div>
