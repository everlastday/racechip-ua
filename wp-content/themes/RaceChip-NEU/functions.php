	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			...
			<?php
				...
				printf( __( '<span>am</span> %1$s at %2$s', 'twentyten' ), get_comment_date(),  get_comment_time() ); ?></a><?php edit_comment_link( __( '(Edit)', 'twentyten' ), ' ' );
			?>
...
function twentyten_posted_on() {
  printf( __( '<span class="%1$s">Опубликовано: </span>%2$s', 'twentyten' ),
...
//Hook aktivieren
add_action( 'admin_menu', 'guru20_NoCommentsAdmin' );
 ...
 */
  ...
  //  return $title . 'THIS IS TEST TITLE';
  //}

//  add_action('init', 'rewrite_rules');
//  function rewrite_rules(){
//
//    add_rewrite_rule('^chiptuning/([a-zA-Z0-9-]+)v/?$','index.php?pagename=chiptuning&car_id=$matches[1]','top');
//    add_rewrite_rule('^chiptuning/([a-zA-Z0-9-]+)v/([a-zA-Z0-9-_\.\,\+()]+)/?$','index.php?pagename=chiptuning&car_id=$matches[1]&car_name=$matches[2]','top');
//
//    flush_rewrite_rules(true);
//
//  }
