            ...
            <?php
              ...
              foreach ($all_data as $key => $value) {
                ...
                foreach ($all_data_r as $key => $value):
                  ...
                  <li><a class="list_item list_first" href="<?php echo get_bloginfo('wpurl') . "/responsecontrol/" . $value ?>"><span class="name" style="width: 100%;"><?php echo $all_data[$key] ?></span></a></li>
                  <?php
                endif;
                 endforeach;
              ?>
