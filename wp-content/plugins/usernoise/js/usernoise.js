jQuery(function($){
	...
	function UsernoiseButton(){
		...
		if ($button.is('.un-right.css3, .un-left.css3'))
        ...
        var $button2 = $('.un-left.css3.freecall-btn');
        var $button2Size = $button.width() - 1001;

        $button2.css('display', 'block').animate(propOnStart).hover(
            function(){$button2.animate(propOnIn, 100)},
            function(){$button2.animate(propOnOut, 100)});
